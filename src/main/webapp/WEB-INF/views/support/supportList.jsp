			...
			<section id="category-wrap">
				<a href="javascript:void(0)" class="category-links"
					...
					<div class="category" style="background-color: #ffd370;">
						<div>
							<p class="category-p" style="color: white;">전체</p>
						</div>
					</div>
					...
					<div class="category" style="background-color: #F2F2F2;">
						<div>
							<p class="category-p" style="color: black;">주거</p>
						</div>
					</div>
				</a> <a href="javascript:void(0)" class="category-links"
					...
					<div class="category" style="background-color: #F2F2F2;">
						<div>
							<p class="category-p" style="color: black;">생계</p>
						</div>
					</div>
				</a> <a href="javascript:void(0)" class="category-links"
					...
					<div class="category" style="background-color: #F2F2F2;">
						<div>
							<p class="category-p" style="color: black;">건강</p>
						</div>
					</div>
				</a> <a href="javascript:void(0)" class="category-links"
					...
					<div class="category" style="background-color: #F2F2F2;">
						<div>
							<p class="category-p" style="color: black;">개선</p>
						</div>
					</div>
				</a>
				<!-- 글쓰기 버튼 (관리자만 보임)-->
