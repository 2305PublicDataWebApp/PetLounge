...
<html lang="ko">
    ...
    <body>
        ...
        <form action="/notice/noticeUpdate.pet" method="post" enctype="multipart/form-data" id="updateForm">
...
//                     placeholder: '공지사항 내용을 작성해주세요',  //placeholder 설정
		...
		<script>
		    function backToNoticeList() {
		        location.href = "/notice/noticeDetail.pet?nNo="+${notice.nNo };
		    }		
		</script>
    </body>
    </html>
