...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" href="/resources/css/notice/notice_submit.css">
...
<!--         <link rel="stylesheet" href="/resources/css/font.css"> -->
    ...
    <body>
        ...
        <form action="/notice/notice_submit.pet" method="post" enctype="multipart/form-data" id="submitForm">
