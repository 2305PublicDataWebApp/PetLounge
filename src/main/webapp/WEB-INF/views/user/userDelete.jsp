...
<link rel="stylesheet" href="/resources/css/user/myPage/delete.css">
<link rel="stylesheet" href="/resources/css/user/myPage/deleteForm.css">
		...
		<section style="padding-top: 120px;">
			<div id="wrap" class="clearfix">
				...
				<section class="contents">
					...
					<div>
						<form action="/delete/page.do" method="get">
							<article class="find1">
								<!-- <h2>회원가입</h2> -->
