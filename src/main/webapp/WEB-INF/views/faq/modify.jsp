        ...
        <main class="main">
            <div class="contanier">
                ...
                <div class="main-title">
                    <h1 id="title-text">FAQ 수정</h1>
                </div>

                <div id="line"></div>

                <!-- 게시글 등록 -->
                <form action="/faq/modify.pet" method="post">
	                ...
	                <div id="board-title">
						<div id="faq-borad">
						    ...
						    <div id="content">
						        <input type="text" name="faqTitle" id="faq-title" value="${ faq.faqTitle }" placeholder="제목을 입력해 주세요.">
						    </div>
						</div>
						
							<!-- 내용 -->
							<textarea name="faqContent" id="summernote" style="display: none;"> ${ faq.faqContent }</textarea>
						
						<div id="btn">
<!-- 							<button id="register-sub" type="button" type="submit">수정하기</button> -->
							<input type="submit" id="modify-sub" value="수정하기">
