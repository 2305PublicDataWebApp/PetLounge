...
public class SupportServiceImpl implements SupportService{
	...
	@Override
	public List<SupportReply> selectSReplyListByNo(int sNo) {
		List<SupportReply> sRList = sStore.selectSReplyListByNo(sqlSession, sNo);
		return sRList;
	}

	@Override
	public int getReplyListCountByNo(int sNo) {
		int result = sStore.getReplyListCountByNo(sqlSession, sNo);
		return result;
	}
